...
class sportsNews : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rView = findViewById<RecyclerView>(R.id.rView2)
    ...
    private fun fetch() {
        ...
        val url = "https://newsapi.org/v2/?country=in&category=sports&apiKey=843f25213cda4092869865a497d31019"
    ...
    fun onItemClicked(item: Data) {
        ...
        builder = builder.setToolbarColor(ContextCompat.getColor(this@sportsNews, R.color.colorPrimary))
